          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white shadow-sm border border-gray-200">
            ...
            <span
              className={`text-xs font-medium ${
                isRobotOnline ? "text-green-700" : "text-gray-600"
              }`}
            >
              ...
              <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${Math.min(
                      100,
                      Math.max(0, localRobot.battery_level),
                    )}%`,
                  }}
                />
              </div>
          ...
          <div className="relative bg-white rounded-xl shadow-2xl max-w-md w-full overflow-hidden border border-gray-200">
            ...
            <div
              className={`p-6 border-b ${
                isRobotOnline ? "border-red-100" : "border-amber-100"
              }`}
            >
              <h3 className="text-xl font-bold text-gray-900">
                {isRobotOnline
                  ? "Cannot Deactivate Robot"
                  : "Deactivate Robot?"}
              </h3>
            </div>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-red-50 border border-red-200 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-red-700 text-sm">
                        <strong className="font-bold">{localRobot.name}</strong>{" "}
                        cannot be deactivated while it is online. Deactivation
                        is only allowed when the robot is offline. Please wait
                        for the robot to go offline and try again.
                      </p>
                    </div>
                  </div>
                ) : (
                  ...
                  <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-amber-700 text-sm">
                        Deactivating{" "}
                        <strong className="font-bold">{localRobot.name}</strong>{" "}
                        will block all robot access, including user listings and
                        operations. This action will stop all active tasks and
                        prevent the robot from receiving new assignments.
                      </p>
                    </div>
                  </div>
                )}
