...
export default function LoginPage() {
    ...
    // ✅ FIX 1: Track client-side mount to avoid SSR mismatch
    ...
    /* ── FIX 2: Set mounted flag first, THEN check auth ─────────────────── */
    useEffect(() => {
        setMounted(true);
    }, []);

    useEffect(() => {
        // ✅ Only runs on client after mount — safe to access localStorage
        if (!mounted) return;
    ...
    // ✅ FIX 3: Render nothing (or a skeleton) until client has mounted
    // This prevents SSR/client hydration mismatch entirely
    if (!mounted) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50">
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100 h-[420px] animate-pulse" />
                </div>
            </div>
        );
    }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 p-4">
        <div className="w-full max-w-md">
            ...
            <div className="relative">
                {/* Login Card */}
                <div className={`transition-all duration-300 ${view === 'login' ? 'block' : 'hidden'}`}>
                ...
                {/* Register Card */}
                <div className={`transition-all duration-300 ${view === 'register' ? 'block' : 'hidden'}`}>
                    <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
                ...
                <div className={`transition-all duration-300 ${view === 'forgot' ? 'block' : 'hidden'}`}>
                    <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-semibold text-indigo-600">Verify Email</span>
                            </div>
                        ...
                        <h2 className="text-xl font-bold text-gray-900 mb-1">Enter your email</h2>
                        <p className="text-sm text-gray-500 mb-6">We'll send you a token to reset your password.</p>
                ...
                {/* Reset Password Card */}
                <div className={`transition-all duration-300 ${view === 'reset' ? 'block' : 'hidden'}`}>
                    <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-semibold text-green-600">Email Verified</span>
                            </div>
        ...
        <style jsx>{`
            ...
            .animate-modalIn { animation: modalIn 0.35s cubic-bezier(0.34, 1.56, 0.64, 1); }
        `}</style>
    </div>
    );
}
